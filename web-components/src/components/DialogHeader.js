...
template.innerHTML = `
    ...
    <div class="header">
        <div class="menu"><img src="https://img.icons8.com/ios-glyphs/30/000000/beefburger.png"> </div>
        <div class="messenger">Messanger</div>
        <div class="search"><img src="https://img.icons8.com/wired/30/000000/search.png"></div>
    </div>
    <form></form>
`;
